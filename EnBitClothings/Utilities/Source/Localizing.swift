...
extension String {
    ...
    //MARK: - Registration
    static let ProfileTitle = NSLocalizedString("Image Upload", comment: "")
    static let ProfileMessage = NSLocalizedString("Your image has been successfully uploaded", comment: "")
